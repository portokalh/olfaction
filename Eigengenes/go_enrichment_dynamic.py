...
# -*- coding: utf-8 -*-
"""
Improved WGCNA-style GO enrichment script:
- Filters low-variance genes
- Computes coexpression network
- Uses dynamic height cut for modules
- Runs GO:BP enrichment for modules with >= 5 genes
- Saves enrichment results and plots
"""
