...
# -*- coding: utf-8 -*-
"""
Integrated WGCNA-GO analysis pipeline:
- Applies strict variance and module size filters
- Clusters genes with soft threshold and dynamic cut
- Runs GO enrichment (GO:BP)
- Outputs top terms per module
- Builds interpretable heatmap
"""
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "gene_dendrogram.png"))
...
for mod in valid_modules:
    ...
    # Build heatmap data (cap -log10(p) to 50)
...
# === STEP 5: Save summary + plot heatmap ===
...
if not heatmap_df.empty:
    plt.figure(figsize=(min(25, heatmap_df.shape[1] * 1.0), 0.6 * len(heatmap_df)))
